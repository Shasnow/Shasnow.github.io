...
对于 *macOS* ,~~如果你有足够资金供开发者购入**MacBook**, **iMac**, **Mac mini**或**Mac Studio**设备并向我们提供，可能会着手针对 *macOS* 系统开发。~~
...
点击`Download it now`(或直接点击前往https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-8.0.25-windows-x64-installer)，在弹出的浏览器窗口等待程序下载完成，打开下载的程序安装。
