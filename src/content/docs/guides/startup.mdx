...
1. 按下您键盘上的Windows徽标键，搜索“任务计划程序”，并打开它。
   ![任务计划程序](/src/assets/img/use/taskschd1.png)

2. 点击创建任务，填写任务名称，例如“SRA自动运行”。
   ![创建任务](/src/assets/img/use/taskschd2.png)

3. 注意勾选“使用最高权限运行”，以确保SRA-cli能够正常运行。
   ![使用最高权限运行](/src/assets/img/use/taskschd3.png)

4. 点击触发器，设置任务的触发条件，例如“在登录时”或“按计划”。
   ![触发器](/src/assets/img/use/taskschd4.png)

5. 点击操作，添加一个新操作，选择“启动程序”。
   ![操作](/src/assets/img/use/taskschd5.png)
